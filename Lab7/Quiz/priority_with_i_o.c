...
struct process
{
    int pid,burst_time_1,priority,burst_time_2,io_time,arrival_time,arrival,rt;
    bool done,io;
...
int main()
{
    ...
    struct process temp;
    cout<<"\n Enter the details for "<<pno<<" processes <id  arrival_time priority burst_time_1 io_time burst_time_2> : \n";

    for(int i=0; i<pno; i++)
    {
        cout<<"\n     Process "<<i+1<<" : ";
        cin>>temp.pid>>temp.arrival_time>>temp.priority>>temp.burst_time_1>>temp.io_time>>temp.burst_time_2;
